...
import { createAnnouncementMigrationPacket } from "@/lib/cms/announcement-migration";
...
export async function GET() {
  ...
  return new Response(`${JSON.stringify(packet, null, 2)}\n`, {
    headers: {
      ...
      "content-disposition": `attachment; filename="sskem-announcement-intake-${date}.json"`,
